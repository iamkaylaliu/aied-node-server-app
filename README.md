# **Unveil Genius: AI Science Museum with Historical Figures - Backend**
...
For the **frontend repository**, visit: [Frontend Repository](https://github.com/iamkaylaliu/aied-react-web-app)  
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/iamkaylaliu/aied-node-server-app.git
   ```
2. **Navigate to the project directory**:
   ```bash
   cd aied-node-server-app
   ```
